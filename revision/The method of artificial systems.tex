...
design inventories. Its purpose is to state, as plainly as possible,
what the present research object is, why it matters to the thesis,
and how another researcher could reproduce or challenge the work under
...
to Volatco because the board is the strongest current place where that
...
the present experimental center of the manifesto. If the manuscript
is to stand as more than philosophical preference, it must end near
the apparatus on which its strongest claims can actually be tested.
...
This standard is intentionally conservative. The point is not to make
the work sound larger than it is. The point is to give the field a
repeatable path from conceptual claim to bounded technical result.
